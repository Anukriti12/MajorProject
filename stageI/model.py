...
class CondGAN(object):
    def __init__(self, image_shape):
        self.batch_size = config.cfg.TRAIN.BATCH_SIZE
        self.network_type = config.cfg.GAN.NETWORK_TYPE
        self.image_shape = image_shape
        self.gf_dim = config.cfg.GAN.GF_DIM
        self.df_dim = config.cfg.GAN.DF_DIM
        self.ef_dim = config.cfg.GAN.EMBEDDING_DIM
        ...
        if config.cfg.GAN.NETWORK_TYPE == "default":
        ...
        elif config.cfg.GAN.NETWORK_TYPE == "simple":
            with tf.variable_scope("d_net"):
    ...
    def generate_condition(self, c_var):
        conditions =\
            (pt.wrap(c_var).
             ...
             apply(custom_ops.leaky_rectify, leakiness=0.2))
